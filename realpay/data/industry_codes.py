...
※ 940911은 스펙 반영으로 추가된 코드로, 경비율이 아직 근사치(mock)임 — 홈택스 검증 필요.
"""
...
INDUSTRY_CODES = {
    ...
    "940306": IndustryCode(
        ...
        basic_deduction=0,
        platforms=("유튜브", "트위치", "네이버클립", "탈잉", "클래스101"),
    ),
    "950001": IndustryCode(
        code="950001",
    ...
    # --- 전문서비스/IT 인적용역 (2025 귀속 홈택스 실제 고시값 검증 완료) ---
    "940926": IndustryCode(
        code="940926",
        name="소프트웨어 프리랜서(SW 개발·제작·운영 용역)",
        category="인적용역",
        simple_expense_rate=0.644,
        standard_expense_rate=0.209,
        basic_deduction=0,
        platforms=("위시켓", "프리모아", "이랜서"),
    ),
}
...
PLATFORM_TO_CANDIDATE_CODES = {
    ...
    "청소연구소": ["950001", "940909"],
    "대리주부": ["950001", "940909"],
    # 전문서비스 / 데이터라벨링 — 검증된 별도 코드가 없어 기타자영업(940909)으로 신고하는 게 실무 관행
    "크몽": ["940909"],
    "숨고": ["940909"],
    "크라우드웍스": ["940909"],
    "셀렉트스타": ["940909"],
    "에이모": ["940909"],
    # IT/개발 외주 — 소프트웨어프리랜서 코드
    "위시켓": ["940926", "940909"],
    "프리모아": ["940926", "940909"],
    "이랜서": ["940926", "940909"],
    # 창작·교육 (크리에이터 코드 재사용)
